class DropBoxController {
    ...
    constructor() {
        ...
        this.listFilesEl = document.getElementById('list-of-files-and-directories')


        this.progressModalEl = document.getElementById('react-snackbar-root')
        ...
        this.navEl = document.getElementById('browse-location')
    }
    ...
    connectFirebase() {
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyCjE_qM5vhq91PsVQIWQl8TKClVkp2zzk0",
            authDomain: "dropbox-clone-a4f80.firebaseapp.com",
            databaseURL: "https://dropbox-clone-a4f80-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-a4f80",
            storageBucket: "dropbox-clone-a4f80.appspot.com",
            messagingSenderId: "84340528810",
            appId: "1:84340528810:web:8e2f474f0f5075259f62d3",
            measurementId: "G-3Q065MTBKM"
        };
        // Initialize Firebase
    ...
    removeTask() {
        ...
        this.returnSelectedItem().forEach(li => {
    ...
    initEvents() {
        ...
        let btnNewFolder = document.getElementById('btn-new-folder')
        ...
        btnDelete.addEventListener('click', e => {
            ...
            this.removeTask().then(response => {
                ...
                response.forEach(file => {
                    ...
                    if (file.fields.key) {
                        this.getFirebaseRef().child(file.fields.key).remove()
                    }
        ...
        let btnrename = document.getElementById('btn-rename')

        btnrename.addEventListener('click', e => {

            let li = this.returnSelectedItem()[0]
        ...
        this.listFilesEl.addEventListener('selectionchange', event => {
            ...
            switch (this.returnSelectedItem().length) {
                case 0:
    ...
    uploadTask(files) {
        ...
        let filesSpreaded = [...files]



        filesSpreaded.forEach(file => {
    ...
    uploadProgress(event, file) {
        ...
        let timeExpended = Date.now() - this.startUploadTime

        let loaded = event.loaded
        let total = event.total
        let porcent = parseInt((loaded / total) * 100)

        let timeLeft = ((100 - porcent) * timeExpended) / porcent
        ...
        console.log(timeExpended, timeLeft, porcent)
    ...
    modalShow(show = true) {
        ...
        this.progressModalEl.style.display = (show) ? 'block' : 'none'
    ...
    renderNav() {
        ...
        let path = []
        let navEl = document.getElementById('browse-location')
        ...
        for (let i = 0; i < this.currentFolder.length; i++) {
            ...
            if ((i + i) === this.currentFolder.length) {
